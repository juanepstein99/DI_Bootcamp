...
# name to store the farm’s name and animals to store the animals (initialize as an empty dictionary).
...
# Step 1: Create the Farm Class  # Step 2: Implement the __init__ Method
class Farm: 
...
# Step 4: Implement the get_info Method
    def get_info(self):
        ...
        for animal_type, count in self.animals.items():
            info = (info + f"{animal_type} : {count}\n")
        info = (info + f"\n")
        info = (info + f"E-I-E-I-0!")
        return info
...
# Step 7: Implement the get_short_info Method
    def get_short_info(self):
        ...
        sentence = ", ".join(animals_with_s[:-1]) + " and " + animals_with_s[-1]
